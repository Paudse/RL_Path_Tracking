...
plt.plot(sim_x[0:380], [i*180/np.pi for i in sim_d_pure_pursuit[0:380]], "--g", label="Pure-Pursuit")
plt.plot(sim_x[0:380], [i*180/np.pi for i in sim_d_RL[0:380]], "orange", label="PPO")
# plt.plot(sim_x[0:380], [(i+j)*180/np.pi for i,j in zip(sim_d_RL[0:380],sim_d_pure_pursuit[0:380])], "-b", label="Pure-Pursuit+PPO")
# plt.plot(sim_x_1[0:380], [i*180/np.pi for i in sim_d_pure_pursuit_1[0:380]], "--k", label="Pure-Pursuit")
plt.grid(True)
plt.xlabel("x [m]")
plt.ylabel("Steering Cmd [$^\circ$]")
plt.legend(loc='upper left')
plt.ylim(-50,60)
# plt.ylim(-25,30)
